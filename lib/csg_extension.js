...
CSG.Polygon.prototype.saveDistancesFromOriginPoint = function(originPoint) {
  this.vertexDistances = [];
  for (var vertex of this.vertices) {
    this.vertexDistances.push(new CSG.Vector(vertex.pos.x - originPoint.x,vertex.pos.y - originPoint.y,vertex.pos.z - originPoint.z));
  }
}

CSG.Polygon.prototype.setVerticesFromOriginPoint = function(originPoint) {
  var vertex;
  for (var vi in this.vertices) {
    vertex = this.vertices[vi];
    vertex.pos.x = originPoint.x + this.vertexDistances[vi].x;
    vertex.pos.y = originPoint.y + this.vertexDistances[vi].y;
    vertex.pos.z = originPoint.z + this.vertexDistances[vi].z;
  }
