...
CSG.prototype.rotateOnAxis = function(axisVector, angle) {
  var vertexThreeJs;
  for (var polygon of this.polygons) {
    for (var vertex of polygon.vertices) {
      vertex.pos = vertex.backup.clone();
      vertex.pos.rotateVertexOnAxis(axisVector,angle);
      vertex.normal.rotateVertexOnAxis(axisVector,angle);
    }
